<template>
	<view>
		...
		<view class="main">
			<view class="title">扫码接单</view>
			<u-button type="primary" :plain="true" @click="routeChange('/pages/choise/choise')">
				<u-icon name="scan"></u-icon>
				扫描二维码
			</u-button>

			<view class="title">保险服务</view>
			...
			<view class="contact ac">地址：{{ contact.address }}</view>
			<view class="contact ac">电话：{{ contact.phone }}</view>
			<view class="contact ac">邮箱：{{ contact.mailbox }}</view>
		</view>
	</view>
</template>
